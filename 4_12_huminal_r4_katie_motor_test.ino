...
float len;
char motions[] = {'S', 'R', 'S', 'R'}; // Now we have an option for each of the four motor movement options (left, right, straight, head) /* this can be changed to SRLH for testing, RRRR would be a circle */
char motion;
